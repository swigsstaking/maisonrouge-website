    ...
    <div className="mt-4 pt-4 border-t border-gray-200">
      ...
      {!googleBtnRendered && (
        <button
          ...
          className="w-full flex items-center justify-center gap-3 px-4 py-2.5 border border-gray-300 bg-white hover:bg-gray-50 transition-colors text-sm text-gray-700 rounded"
        >
